...
+---------+------------+------------+--------------+---------------+-----------+-------------+----------+--------+------+------------+---------+---------------+
| request |          0 | PRIMARY    |            1 | id            | A         |           0 |     NULL | NULL   |      | BTREE      |         |               |
| request |          0 | uk_request |            1 | customer_id   | A         |           0 |     NULL | NULL   |      | BTREE      |         |               |
| request |          0 | uk_request |            2 | request_title | A         |           0 |     NULL | NULL   |      | BTREE      |         |               |
+---------+------------+------------+--------------+---------------+-----------+-------------+----------+--------+------+------------+---------+---------------+
...
class Request extends AFWObject{
        ...
        public static $REQUEST_STATUSES_ONGOING_INVESTIGATOR = "2,201,4";
        ...
        public static $PUB_METHODS = array("resetRequestNew" => array('title' => "إرجاع إلى حالة مسودة", 
                                            ...
                                            "approveResponse" => array('title' => "اعتماد الاجابة الأخيرة", 
                                                                      'confirmation_needed' => true, 
                                                                      'confirmation_warning' => "هذا الإجراء غير قابل للرجوع إلى الخلف", 
                                                                      'confirmation_question' => "هل أنت متأكد أنك تريد اعتماد الاجابة الأخيرة للمنسق ؟",
                                                                      'color' => "green"),

                                            "unCloseRequest" => array('title' => "الغاء اغلاق الطلب", 
                                                                      'confirmation_needed' => true, 
                                                                      'confirmation_warning' => "---------------------", 
                                                                      'confirmation_question' => "هل أنت متأكد أنك تريد إرجاع الطلب إلى حالة جاري العمل ؟",
                                                                      'color' => "red"),

                                            "sendRequest" => array('title' => "إرسال/إرجاع الطلب إلى خدمة العملاء", 
                                                                   'confirmation_needed' => false, 
                                                                   'confirmation_warning' => "", 
                                                                   'confirmation_question' => "",
                                                                   'color' => "blue"),

                                            "startRequest" => array('title' => "بدء العمل على الطلب", 
                                                    'confirmation_needed' => false, 
                                                    'confirmation_warning' => "", 
                                                    'confirmation_question' => ""),                                                                   

                                            "refreshRequest" => array('title' => "تحديث بيانات الطلب", 
                                                    'confirmation_needed' => false, 
                                                    'confirmation_warning' => "", 
                                                    'confirmation_question' => "",
                                                    'color' => "blue"),                                                     

                                            "assignRequest" => array('items'=>'getInvestigators', 
                                                                     'title' => "إسناد الطلب إلى [item]", 
                                                                     'confirmation_needed' => false, 
                                                                     'confirmation_warning' => "", 
                                                                     'confirmation_question' => ""),

                                            "redirectRequest" => array('title' => "طلب إعادة توجيه لعدم الإختصاص", 
                                                                        'confirmation_needed' => false, 
                                                                        'confirmation_warning' => "", 
                                                                        'confirmation_question' => "",
                                                                        'color' => "yellow"),

                                            "returnRequestToInvestigator" => array('title' => "إعادة الطلب إلى المنسق", 
                                                                                    'confirmation_needed' => false, 
                                                                                    'confirmation_warning' => "", 
                                                                                    'confirmation_question' => "",
                                                                                    'color' => "green"), 

                                            "doneRequest"   => array('title' => "تحويل إلى طلب منجز", 
                                                                        'confirmation_needed' => false, 
                                                                        'confirmation_warning' => "", 
                                                                        'confirmation_question' => ""),

                                            "cancelRequest" => array('title' => "إلغاء الطلب بناء على رغبة العميل", 
                                                                        'confirmation_needed' => true, 
                                                                        'confirmation_warning' => "", 
                                            ...
                                            "closeRequest"  => array('title' => "غلق الطلب", 
                                                                        'confirmation_needed' => false, 
                                                                        'confirmation_warning' => "", 
                                                                        'confirmation_question' => "",
                                            ...
                                            "rejectRequest" => array('title' => "رفض الطلب", 
                                                                        'confirmation_needed' => false, 
                                                                        'confirmation_warning' => "", 
                                                                        'confirmation_question' => "",
                                                                        'color' => "orange"), 

                                            "ignoreRequest" => array('title' => "إهمال الطلب", 
                                                                        'confirmation_needed' => false, 
                                                                        'confirmation_warning' => "", 
                                                                        'confirmation_question' => "",
                                                                        'color' => "red"), 

                                            "removeLastResponse" =>  array('title' => "حذف آخر ردودي", 
                                                                        'confirmation_needed' => true, 
                                                                        'confirmation_warning' => "", 
        ...
        public static $STATUS_MAP = array(
                  0 => array("submitRequest"=>"iamTheCustomer", 
                             "refreshRequest"=>"goOn",  
                ...
                // NEW -  مسودة طلب جديد  $REQUEST_STATUS_DRAFT = 1; 
                  1 => array("resetRequestNew"=>"neverDoThisNow",
                ...
                // SENT - طلب مرسل  للتحقيق $REQUEST_STATUS_SENT = 2; 
                  2 => array("resetRequestNew"=>array(true, "iamTheCustomer", "iamTheSupervisor"),
                              "assignRequest"=>"iamTheSupervisor",
                ...
                // REDIRECT - طلب إعادة التحويل  $REQUEST_STATUS_REDIRECT = 3; 
                  3 => array("resetRequestNew"=>"neverDoThisNow",
                              "assignRequest"=>"iamTheSupervisor",
                              "approveResponse"=>array(false, "needResponseApproval", "iamTheSupervisor"),
                              "redirectRequest"=>"neverDoThisNow",
                              "returnRequestToInvestigator"=>"neverDoThisNow", 
                ...
                // ONGOING - طلب تحت الإنجاز - جاري العمل $REQUEST_STATUS_ONGOING = 4;
                 4 => array("resetRequestNew"=>"neverDoThisNow",
                ...
                // DONE - تمت الإجابة   $REQUEST_STATUS_DONE = 5;              
                 5 => array("resetRequestNew"=>"iamTheSuperAdmin",
                ...
                // CANCELED - طلب ملغى   $REQUEST_STATUS_CANCELED = 6;               
                 6 => array("resetRequestNew"=>"canResetAsNew",
                              "assignRequest"=>"neverDoThisNow",
                              "redirectRequest"=>"neverDoThisNow",
                              "returnRequestToInvestigator"=>array(false, "isAssigned", "iamTheSupervisor"), 
                              "doneRequest"=>array(false, "iResponded", "iamTheInvestigator"),
                ...
                7 => array("resetRequestNew"=>"iamTheSuperAdmin",
                              "assignRequest"=>"neverDoThisNow",
                              "redirectRequest"=>"neverDoThisNow",
                              "returnRequestToInvestigator"=>"neverDoThisNow", 
                              "doneRequest"=>"neverDoThisNow",
                ...
                8 => array("resetRequestNew"=>"iamTheSupervisor",
                              "assignRequest"=>"neverDoThisNow",
                              "redirectRequest"=>"neverDoThisNow",
                              "returnRequestToInvestigator"=>"neverDoThisNow", 
                              "doneRequest"=>"neverDoThisNow",
                ...
                9 => array("resetRequestNew"=>"iamTheSupervisor",
                              "assignRequest"=>"neverDoThisNow",
                              "redirectRequest"=>"neverDoThisNow",
                              "returnRequestToInvestigator"=>"neverDoThisNow", 
                              "doneRequest"=>"neverDoThisNow",
    ...
    public static $DB_STRUCTURE = null; 
        ...
        public static $STATS_CONFIG = array(
                "gs001"=> array("STATS_WHERE"=>"active = 'Y' and request_date between [date_start_perf] and [date_end_perf]", // 
                                "DISABLE-VH" => true,
                                "FOOTER_TITLES" => true,
                                "FOOTER_SUM" => true,
                                "GROUP_SEP"=>".",
                                ...
                                "OPTIONS" => array("perf"=> array('count_request' => true, 'request_done' => true, 'request_late' => true, 'request_ongoing' => true, 'perf'=>true),
                                        ),
                ...
                "gs002"=> array("STATS_WHERE"=>"active = 'Y' and status_id in (2,201,3,301,4)", // 
                               "DISABLE-VH" => true,
                               "FOOTER_TITLES" => true,
                               "FOOTER_SUM" => true,
                               "GROUP_SEP"=>".",
...
*/
                ...
                "gs003"=> array("STATS_WHERE"=>"active = 'Y' and request_date between [date_start_stats] and [date_end_stats]", // 
                              "DISABLE-VH" => true,
                              "FOOTER_TITLES" => true,
                              "FOOTER_SUM" => true,
                              "GROUP_SEP"=>".",
                ...
                "gs004"=> array("STATS_WHERE"=>"active = 'Y' and request_date between [date_start_stats] and [date_end_stats]", // 
                             "DISABLE-VH" => true,
                             "FOOTER_TITLES" => true,
                             "FOOTER_SUM" => true,
                             "GROUP_SEP"=>".",
...
/*
                ...
                "gs005"=> array("STATS_WHERE"=>"active = 'Y' and status_id = 7 and status_date between [date_start_perf] and [date_end_perf]", // 
                            "DISABLE-VH" => true,
                            "FOOTER_TITLES" => true,
                            "FOOTER_SUM" => true,
                            "SHOW_PIE" => "FOOTER",
	 ...
	 public function __construct(){
        ...
        public function addCustomerComment($comment)
        {
            ...
            $resoObj = Response::createNewResponse($this->getId(), AfwDateHelper::currentHijriDate(), date("H:i:s"), 
                                    0, 0, $new_status_id, 
                                    self::$RESPONSE_TYPE_COMMENT, $comment, 
        ...
        public function changeStatus($new_status_id, $status_comment, $internal="N", $silent=false)
        {
                ...
                if($new_status_id != $this->getVal("status_id"))
                {
                    ...
                    if((!$silent) and (!$silent_force))
                    {
                            ...
                            */
                            ...
                            $resoObj = Response::createNewResponse($this->getId(), AfwDateHelper::currentHijriDate(), date("H:i:s"), 
                                                    $orgunit_id, $employee_id, $new_status_id, 
                                                    $response_type, $status_comment, 
                                                    $response_link="", $internal, $module_id = 0);
                            ...
                            {
                                if(($new_status_id == Request::$REQUEST_STATUS_SENT) or ($new_status_id != Request::$REQUEST_STATUS_ONGOING)) $success_message = $this->tm("ticket sent to customer care", $lang);
                                elseif($new_status_id == Request::$REQUEST_STATUS_CANCELED) $success_message = $this->tm("ticket canceled", $lang);                               
                                else $success_message = $this->tm("status changed to", $lang)." \"".$this->getCustomerStatus($lang)."\"";


                                if($survey_url)
                                {
                                    $success_message .= " :  رابط الاستبيان : " . $survey_url;
                                }
                    ...
                    if(
                        ($new_status_id != $this->getVal("status_id")) and 
                        (($new_status_id == Request::$REQUEST_STATUS_MISSED_FILES) or 
                         ...
                         (($this->getVal("status_id") == Request::$REQUEST_STATUS_RESPONSE_UNDER_REVISION) and ($new_status_id == Request::$REQUEST_STATUS_CLOSED))
                        )
                       )
                    {
                        // send SMS to warn customer
                        $token_arr = array("[title]" => $this->getVal("request_title"));
                        $this->sendSmsToCustomer($template="news", $lang, $token_arr);
                        AfwSession::pushSuccess("تم اعلام العميل بهذا التغيير على التذكرة");                        
                    }
                ...
                if($new_status_id != $this->getVal("status_id"))
                {
                    if($new_status_id == self::$REQUEST_STATUS_CLOSED)
                    {
                        $resoObj->other_infos["survey_url"] = CrmLimesurvey::surveyClosedTicket($this);                        
                    }
                }
                */
                
                return array($resoObj, $errors, $warnings, $infos);
        ...
        public function sendRequest($lang = "ar")
        {
                ...
                // send the request 
                $status_comment = "تم إرسال الطلب إلى مشرف خدمة العملاء من أجل الاعتماد";
                $this->changeStatus(self::$REQUEST_STATUS_SENT, $status_comment);
        ...
        public function resetRequestNew($lang="ar")
        {
            ...
            $this->changeStatus(self::$REQUEST_STATUS_DRAFT, $status_comment);
        ...
        public function redirectRequest($lang="ar")
        {
                ...
                $this->changeStatus(self::$REQUEST_STATUS_REDIRECT, $status_comment, $internal="Y");
                return array("", $status_comment);
        }
        ...
        public function startRequest($lang="ar")
        {
             ...
             $this->changeStatus(self::$REQUEST_STATUS_ONGOING, $status_comment);
             return array("", $status_comment);
        }
        
        public function doneRequest($lang="ar")
        {
             $status_comment = "تم عمل المطلوب";
             
             // if level of investigator = starting => internal = W (all responses should be validated by supervisor before show to customer)
             $this->changeStatus(self::$REQUEST_STATUS_DONE, $status_comment);
             return array("", $status_comment);
        }
        ...
        public function cancelRequest($lang="ar")
        {
             ...
             $this->changeStatus(self::$REQUEST_STATUS_CANCELED, $status_comment);
             return array("", $status_comment);
        }
        ...
        public function unCloseRequest($lang="ar")
        {
             ...
             $resoObj = $this->changeStatus(self::$REQUEST_STATUS_DONE, $status_comment);
        ...
        public function closeRequest($lang="ar")
        {
            ...
            $resoObj = $this->changeStatus(self::$REQUEST_STATUS_CLOSED, $status_comment);
        ...
        public function rejectRequest($lang="ar")
        {
             ...
             $this->changeStatus(self::$REQUEST_STATUS_REJECTED, $status_comment);
             return array("", $status_comment);
        }            
        ...
        protected function getPublicMethods()
        {
            ...
            {    
                    ...
                    {                      
                        if((!$this->getVal("supervisor_id")) or $objme->isSuperAdmin())
                        {
                            ...
                            $pbms["xc143A"] = array("METHOD"=>"assignBestAvailableSupervisor",
                                    "COLOR"=>$color, "LABEL_AR"=>$title_ar, 
                                    "PUBLIC"=>true, "BF-ID"=>"", "HZM-SIZE" =>12,
                                    );
                        }
            ...
            foreach(self::$STATUS_MAP[$curr_status_parent] as $methodName0 => $methodProps)
            {
                ...
                foreach($itemsList as $itemId => $itemPbm)
                {
                    ...
                    if($method_allowed)
                    {
                        $pbms[substr(md5($methodName.$itemTitle),1,5)] = array("METHOD"=>$methodName, 
...
*/
        ...
        public static function assignSupervisorForNonAssigned($reset=false, $silent=false, $lang="ar", $limit="200")
        {
            ...
            if($reset) 
            {
                ...
                $obj->where("(employee_id = 0 and status_id not in (5,6,7,8,9)) or (orgunit_id = ".self::$CRM_CENTER_ID.")"); //  or (supervisor_id = 1917 and employee_id = 1791)
                $obj->update(false);
            }
            ...
            $obj->where("status_id not in (5,6,7,8,9)");
            ...
            $infos_arr[] = "supervision done ".count($reqList)." request(s) with $nb_errs error(s)";
        ...
        public function calcUl_cl_files()
        {
             ...
             foreach($pfiles_arr as $pfileObj)
             {
               if($pfileObj)
               {  
                 $p_title = $pfileObj->getVal("description");
