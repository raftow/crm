<?php
// ------------------------------------------------------------------------------------
// ----             auto generated php class of table response : response - الإجابات والتعليقات عن الإستفسارات 
// ------------------------------------------------------------------------------------
...
class Response extends AFWObject{
	...
	public static $DATABASE		= ""; 
        ...
        public static function createNewResponse($request_id, $response_date, $response_time, 
                                      $orgunit_id, $employee_id, $new_status_id, $response_type_id, $response_text, 
        ...
        public function getActionTitle($lang="ar")
        {
               $data = array();
               $link = array();
                       ...
                       if($auto_approve_response)
                       {
                            ...
                            // we do this test to avoid twice or infinite loop because change status create new response                   
                            {
                                ...
                                if($request->getVal("request_priority") <= 3)
                                {
                                        ...
                                        $title = trim(truncateArabicJomla($title, 20)," ");
