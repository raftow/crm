...
class RequestArTranslator
{
	public static function initData()
	{
		...
		$trad['request']['orgunit_id_tooltip'] = 'الإدارة المكلفة بالإجابة التي عينها المشرف ويمكن طلب إعادة التحويل في حال عدم التخصص. بعد تعيين الإدارة والحفظ سيتم آليا اسناد الطلب لأحد المنسقين في هذه الجهة';
		$trad['request']['employee_id_tooltip'] = 'موظف الإدارة المكلف بالتحقيق ثم بتحرير الإجابة. بعد تعيين الإدارة والحفظ سيتم آليا اسناد الطلب لأحد المنسقين في هذه الجهة';
		...
		$trad['request']['archive'] = "في الأرشيف";
