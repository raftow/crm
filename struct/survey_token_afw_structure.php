...
class CrmSurveyTokenAfwStructure
{
    ...
    public static function initInstance(&$obj)
    {
        if ($obj instanceof SurveyToken) {
            ...
            $obj->OwnedBy = array('module' => "crm", 'afw' => "Survey", 'afw2' => "CrmCustomer");
