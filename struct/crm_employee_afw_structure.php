...
class CrmCrmEmployeeAfwStructure
{
	...
	public static $DB_STRUCTURE = array(
		...
		'currentRequests' => array(
			...
			'WHERE' => "(orgunit_id = §orgunit_id§ and employee_id = §employee_id§) and status_id in (201,4)",
			'FORMAT' => 'retrieve',
			'SHOW' => true,
			'EDIT' => false,
			'ICONS' => true,
		...
		'currentSupervisorRequests' => array(
			'STEP' => 2,
			'TYPE' => 'FK',
			'ANSWER' => 'request',
			'ANSMODULE' => 'crm',
			'CATEGORY' => 'ITEMS',
			'ITEM' => '', //'HIDE_COLS' => ['employee_id','orgunit_id'],
			'WHERE' => "supervisor_id = §employee_id§ and status_id in (2,3,301)",
			'FORMAT' => 'retrieve',
			'SHOW' => true,
			'EDIT' => false,
			'ICONS' => true,
		...
		'finishedRequests' => array(
			...
			'CATEGORY' => 'ITEMS',
			'ITEM' => '',
			'WHERE' => "((orgunit_id = §orgunit_id§ and employee_id = §employee_id§) or (supervisor_id = §employee_id§)) and status_id in (5,6,7,8,9) and request_date >= §archive_date§",
			'FORMAT' => 'retrieve',
			'SHOW' => true,
			'EDIT' => false,
			'ICONS' => true,
