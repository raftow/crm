...
else
{
     ...
     $login_out_title = AfwLanguageHelper::tarjemOperator("LOGOUT", $lang);    
                ...
                if($theCustomer)
                {
                        ...
                        $welcome_user = "<span> $welcome </span><br>$firstname <i class=\"fa fa-user\"></i>";
...
<?php
  ...
  $app_name = AfwSession::config("application_name", ['ar'=>"crm"]);
...
<title><?php echo $app_name[$lang]; ?></title>
...
<div class="hzm_front_header cms_container">
        ...
        <div class="title_application">
                <img src="<?php echo $config["img-path"] ?>title-application.png" alt="" class="hzm_front_header_img fleft"/>
        </div>     
