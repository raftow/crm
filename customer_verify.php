 ...
 * @var string $customer_mobile the mobile entered by customer
...
?>
<div class="modal-dialog verify popup-company banner<?php echo $bcounter; ?>">
                                ...
                                <div class="form-group center-me">
                                        ...
                                        <div class='otp-digits-div'>        
                                                ...
                                                <div class='otp-digits-input'>
                                                        <input type="number" class="form-control otp-digits" id="customer_verify_code" name="customer_verify_code" value="" tabindex=0 autocomplete="off" required autofocus>
                                                </div>
                                        </div>
                                        <?php   
                                        }
